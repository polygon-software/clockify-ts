...
var ClockifyError = (function (_super) {
    ...
    function ClockifyError(error) {
        ...
        if (error.response) {
            ...
            message = "Response Error[".concat(requestMethod, ":").concat(statusCode, "]: ").concat((0, http_status_codes_1.getReasonPhrase)(statusCode), ". Message: ").concat(error.response.data.message, ". Resource: ").concat(error.response.data.path);
        }
